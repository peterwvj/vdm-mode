...
(require 'vdm-mode)
(setq vdm-mode-vdm-tool-jar-path "/path/to/vdm-tool-jar")
(vdm-mode-setup)
#+END_SRC
...
~vdm-mode-flycheck-tool-jar-path~ must contain a path to either a [[https://github.com/nickbattle/vdmj][VDMJ]]
or [[https://github.com/overturetool/overture][Overture]] jar file. The syntax checker integration is created using
